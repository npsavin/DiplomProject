...
namespace ExpertSystem
{
    public partial class Default : Page
    {
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            GetNormalFormPrecedent normalForm = new GetNormalFormPrecedent(TextBox1.Text);
            var firstList = normalForm.GetNormalForm();
            var finalList = normalForm.NormalFormAfterExpertEdit(TextBox7.Text, firstList);
            var idPrecedent = MyLibForNeo4J.CreatePrecedent(TextBox1.Text);
